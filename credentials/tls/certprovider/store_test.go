...
// methods on them.
func TestStoreSingleProvider(t *testing.T) {
...
// methods on them.
func TestStoreSingleProviderSameConfigDifferentOpts(t *testing.T) {
...
// would take place.
func TestStoreSingleProviderDifferentConfigs(t *testing.T) {
