...
func TestUpdateControlChannelFirstConfig(t *testing.T) {
...
func TestUpdateControlChannelSwitch(t *testing.T) {
...
func TestUpdateControlChannelTimeout(t *testing.T) {
	server, lis, cleanup := setupwithListener(t)
	defer cleanup()
...
func TestUpdateControlChannelWithCreds(t *testing.T) {
